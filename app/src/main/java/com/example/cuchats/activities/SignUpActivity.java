...
import com.example.cuchats.R;
import com.example.cuchats.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
  ...
  private PreferenceManager preferenceManager;
    ...
    private Boolean isValidSignUpDetails(){
        ...
        else if(!binding.inputPassword.getText().toString().trim().equals
                (binding.inputConfirmPassword.getText().toString().trim())){
            showToast("Password $ confirm passwords must be same");
            return false;
        }
        else return true;
